import 'package:classviii/pages/nepali.dart';
import 'package:classviii/pages/social.dart';
import 'package:classviii/screens/drawer.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    final Uri toTelegram =
        Uri(scheme: 'https', host: 't.me', path: 'class8shikxak');
    final Uri moreNote = Uri(scheme: 'https', host: 'nexucorner.com', path: '');
    return Scaffold(
      appBar: AppBar(
        title: const Text('Class-8 Notes'),
        elevation: 0,
      ),
      drawer: MyDrawer(
